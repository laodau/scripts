...
startup_script_url="https://raw.githubusercontent.com/laodau/scripts/main/auto_titan_edge_for_ryzen.sh"
...
create_vms(){
    ...
    for project_id in $projects; do
        ...
        for zone in "${zones[@]}"; do
            ...
            --create-disk=auto-delete=yes,boot=yes,device-name="$instance_name",image=projects/ubuntu-os-cloud/global/images/ubuntu-2204-jammy-v20240607,mode=rw,size=100,type=projects/"$project_id"/zones/"$zone"/diskTypes/pd-balanced \
